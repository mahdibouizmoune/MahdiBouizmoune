...
export function Document({locale,children}:{locale:Locale;children:React.ReactNode}){
 ...
 return <html lang={locale} dir={locale==='ar'?'rtl':'ltr'}><head><meta name="theme-color" content="#EAE2CE"/></head><body><a className="skip-link" href="#main">{dictionary(locale).a11y.skipToContent}</a>{children}<ClientControls/></body></html>;}
